...
// Registrant is an autogenerated mock type for the Registrant type
type Registrant struct {
	mock.Mock
}

// DeregisterFromCompass provides a mock function with given fields: compassID, globalAccount
func (_m *Registrant) DeregisterFromCompass(compassID string, globalAccount string) error {
...
func (_m *Registrant) RefreshCompassToken(compassID string, globalAccount string) (graphql.OneTimeTokenForRuntimeExt, error) {
	ret := _m.Called(compassID, globalAccount)
...
func (_m *Registrant) RegisterInCompass(compassRuntimeLabels map[string]interface{}) (string, error) {
...
// NewRegistrant creates a new instance of Registrant. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRegistrant(t interface {
	mock.TestingT
	Cleanup(func())
}) *Registrant {
	mock := &Registrant{}
